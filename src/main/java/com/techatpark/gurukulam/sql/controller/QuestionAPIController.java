...
class QuestionAPIController {
    ...
    QuestionAPIController(final QuestionService anQuestionService) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Question> findById(final @PathVariable Integer id) {
...
//        security = @SecurityRequirement(name = "bearerAuth"))
//        @PutMapping("/{id}")
//        public ResponseEntity<Optional<Question>> update(@PathVariable
//        Integer id,
//                        @Valid @RequestBody Question question) {
//                Optional<Question> updatedQuestion = questionService.update(
//                id, question);
//                return updatedQuestion == null ? new ResponseEntity<Optional<
//                Question>>(
