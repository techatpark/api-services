...
CREATE TABLE "user" (
    ...
    authentication_zone_id SMALLINT DEFAULT 1 NOT NULL,
...
CREATE TABLE device (
    ...
    api_flag SMALLINT DEFAULT 1 NOT NULL,
...
CREATE TABLE geo_location_address (
    ...
    address_flag SMALLINT DEFAULT 1 NOT NULL,
...
CREATE TABLE menu (
    ...
    display_flag SMALLINT DEFAULT 0 NOT NULL,
...
CREATE TABLE trip_station_point (
    ...
    actual_distance double precision DEFAULT 0 NOT NULL,
...
CREATE TABLE user_app_store (
    ...
    namespace_id INTEGER NOT NULL,
    user_id INTEGER NOT NULL,
    device_medium_id SMALLINT NOT NULL,
...
CREATE TABLE user_menu (
    ...
    menu_exception_flag SMALLINT NOT NULL,
    active_flag SMALLINT DEFAULT 1 NOT NULL,
    updated_by INTEGER NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    FOREIGN KEY (namespace_id) REFERENCES namespace(id),
...
CREATE TABLE vehicle (
    ...
    overspeed_limit SMALLINT DEFAULT 0 NOT NULL,
    vehicle_type_id SMALLINT DEFAULT 1 NOT NULL,
    active_flag SMALLINT DEFAULT 1 NOT NULL,
    updated_by INTEGER NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    FOREIGN KEY (namespace_id) REFERENCES namespace(id)
