...
CREATE TABLE login_history (
  ...
  login_privider VARCHAR(2) CHECK(
    login_privider = 'EB' OR login_privider = 'FB' OR login_privider = 'GM')
   NOT NULL,
  device_medium VARCHAR(3) CHECK(
    device_medium = 'WEB' OR device_medium = 'API' OR device_medium = 'MOB' OR device_medium = 'APP')
  NOT NULL,
...
CREATE TABLE notification_log (
  ...
  notification_mode VARCHAR(4) CHECK(
    notification_mode = 'MAIL' OR notification_mode = 'SMS') NOT NULL,
...
CREATE TABLE user_menu (
  ...
  refference_type VARCHAR(2) CHECK(refference_type = 'NS' OR refference_type = 'GR' OR refference_type = 'UR') NOT NULL,
